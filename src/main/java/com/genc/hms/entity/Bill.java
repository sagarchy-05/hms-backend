...
public class Bill {
	...
	// Cascade ensures that appointment-related billing updates propagate
	// automatically
	...
	// Date when the bill was issued; restricted to present or past to ensure data
	// integrity
	...
	public Bill(Appointment appointment, Patient patient, BigDecimal billAmount, PaymentStatus paymentStatus,
			LocalDate billDate) {
	...
	public String toString() {
		return "Bill [billId=" + billId + ", appointment=" + appointment + ", billAmount=" + billAmount
