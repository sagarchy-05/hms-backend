...
/**
 * Handles all exceptions globally across the project, providing consistent JSON error responses.
 */
...
public class GlobalExceptionHandler {
    ...
    // Handles wrong email/password during login (Username not found is caught first by the provider)
    ...
    // Handles access denied errors (e.g., attempting to access /api/admin without ADMIN role)
    ...
    // Ensure this remains the last handler as it catches all unhandled RuntimeExceptions.
    @ExceptionHandler(RuntimeException.class)
    public ResponseEntity<Map<String, String>> handleRuntimeException(RuntimeException ex) {
        Map<String, String> error = new HashMap<>();
        // In production, consider logging the full stack trace and returning a generic error message
