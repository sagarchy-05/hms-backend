...
public class JwtService {
	...
	public String generateToken(UserDetails userDetails) {
		...
		// 4. Storing LOGGED_IN_ROLE_ID - Assuming role ID is implicit via the role
		// name.
		// If a separate ID is required, fetch it here. For simplicity, we'll rely on
		// the 'role' name.
	...
	private String buildToken(Map<String, Object> extraClaims, UserDetails userDetails, long expiration) {
		return Jwts.builder().setClaims(extraClaims).setSubject(userDetails.getUsername()) // LOGGED_IN_USER_EMAIL
